...
const generateQuiz = async (projectOrTaskDescription, type, assignee, projectName) => {
  ...
  The user will input a description of the task or project ${projectOrTaskDescription}, the type ${type}, the assignee ${assignee}, and the project name ${projectName}. Based on the ${type}, which indicates the level of granularity (e.g., Project, Epic, Story, Task), the AI should break it down into Epics, Stories, Tasks, and Sub-tasks with detailed descriptions for each task.
  ...
  Project/Task Description: ${projectOrTaskDescription}
  Type: ${type}
  Assignee: ${assignee}
`;
