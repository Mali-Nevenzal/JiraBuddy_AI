    ...
    return (
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', width: '100%' }}>
            <div className="header-container">
                ...
                <div style={{ alignItems: 'center', justifyContent: 'center', width: '100%', paddingRight: '10%' }}>
                    <div className="project-name">Jira Buddy - AI</div>
                    <div className="project-description">Let AI split the tasks, then you can add them to Jira with a single click!</div>
                </div>
            </div>
